...
<head>
	...
	?>
	 ...
	 <link rel="stylesheet" href="<?php echo base_url("resource/bower_components/fullcalendar/dist/fullcalendar.min.css");?>"/>
 	 <link rel="stylesheet"  media="print" href="<?php echo base_url("resource/bower_components/fullcalendar/dist/fullcalendar.print.min.css" );?> "/>
	<style type="text/css">
...
<script type="text/javascript" src="<?=base_url()?>resource/bower_components/moment/moment.js"></script>
<script type="text/javascript" src="<?=base_url()?>resource/bower_components/fullcalendar/dist/fullcalendar.min.js"></script>
